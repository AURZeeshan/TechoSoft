...
# import category file read category file
...
# Input from user 
find = reads
print("your Category name is :", find)
...
for pageNo in range(len(Getpage)):
    ...
    if pageNo >= 0:
        ...
        for c in cats:
            ...
            print("\t Detail NO {} from  ,  Page No << {}  Completed \n".format(key,pageNo))
            driver.close()
        ...
        time.sleep(2) 
        driver.execute_script("window.scroll(4000,5000)")
        print("\t Completed Pages Are :{}, Total Cats :{} ".format(pageNo,key))
